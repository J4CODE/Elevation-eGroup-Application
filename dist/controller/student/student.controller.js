...
let StudentController = class StudentController {
    ...
    async createStudent(response, createStudentDto) {
        try {
            ...
            return response.status(common_1.HttpStatus.CREATED).json({
                message: 'Student egroup has been created successfully',
                newStudent,
            });
        }
        catch (err) {
            return response.status(common_1.HttpStatus.BAD_REQUEST).json({
                statusCode: 400,
                message: 'Error: Student egroup not created!',
                error: 'Bad Request'
            });
        }
    }
    async updateStudent(response, studentId, updateStudentDto) {
        try {
            ...
            return response.status(common_1.HttpStatus.OK).json({
                message: 'Student egroup has been successfully updated',
                existingStudent,
            });
        }
        catch (err) {
    ...
    async getStudents(response) {
        try {
            ...
            return response.status(common_1.HttpStatus.OK).json({
                message: 'All student egroups data found successfully',
                studentData,
            });
        }
        catch (err) {
    ...
    async getStudent(response, studentId) {
        try {
            ...
            return response.status(common_1.HttpStatus.OK).json({
                message: 'Student egroup found successfully',
                existingStudent,
            });
        }
        catch (err) {
    ...
    async deleteStudent(response, studentId) {
        try {
            ...
            return response.status(common_1.HttpStatus.OK).json({
                message: 'Student egroup deleted successfully',
                deletedStudent,
            });
        }
        catch (err) {
